...
export const metadata = {
  title: "Thâm Quyến — Hành Trình Trung Quốc",
};

export default function ShenzhenPage() {
  const city = itinerary.find((c) => c.cityId === "shenzhen")!;
    ...
    <div className="max-w-2xl mx-auto px-4 py-8 md:py-12">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4 mb-6">
        <div className="flex items-start gap-3 text-sm text-blue-800 dark:text-blue-300">
          <span>🚄</span>
          <span>
            Đến từ {tripOverview.transit.from} — {tripOverview.transit.duration} tàu cao tốc
          </span>
        </div>
      </div>
