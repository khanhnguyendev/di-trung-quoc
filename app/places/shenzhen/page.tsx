...
export const metadata = {
  title: "Địa điểm Thâm Quyến — Hành Trình Trung Quốc",
};

export default function ShenzhenPlacesPage() {
  const cityPlaces = places.filter((p) => p.cityId === "shenzhen");
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 md:py-12">
      ...
      <Link href="/places/guangzhou" className="block text-center text-sm text-red-600 dark:text-red-400 hover:underline mt-4">
        ← Xem địa điểm Quảng Châu
      </Link>
    </div>
  );
}
